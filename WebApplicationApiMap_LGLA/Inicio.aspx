<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="WebApplicationApiMap_LGLA.WebForm1" %>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <!-- Ahora agregamos un botón para cerrar el modal -->
                                <div class="col-sm-1">
                            ...
                            <script>
                                $('#ModalMapPreview').locationpicker({
                                    radius: 0,
                                    location: {
                                        latitude: 27.36899861170342,
                                        longitude: - 109.93285133549735
                                    },
